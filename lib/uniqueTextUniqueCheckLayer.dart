...
class UniqueTextUniqueCheckLayer extends MovingLayer {
  ...
  UniqueTextUniqueCheckLayer.common(this._offset, this._progress) {
    _titleColor = UniqueCheckTitleColor;
    _isTitleVisible = true;
    _isCloseButtonVisible = true;
    _onPanUpdateCallback = null;
  ...
  UniqueTextUniqueCheckLayer(this._offset, this._progress, this._titleColor, this._isTitleVisible, this._isCloseButtonVisible, this._onPanUpdateCallback, this._onPanEndCallback, this._closeButtonCallback) {
    build();
  }

  void build() {
    _widget = UniqueCheckWidget(
        TextUniqueCheck(_progress),
        _offset,
        _titleColor,
        _isTitleVisible,
